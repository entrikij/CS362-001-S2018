...
public class CalDayTest{
  ...
  public void test03()  throws Throwable  {
    ...
    string1 = test1.getFullInfomrationApp(test1);
    assertEquals("5-7-2018 \n" +
            "\t3:30PM nullBirthday Party This is my birthday party ", string1);
    ...
    assertEquals("5-7-2018 \n" +
            "\t0:10AM nullBirthday Party This is my birthday party ", string2);

    String string3 = test2.toString();

    assertEquals("\t --- 6/7/2018 --- \n" +
            " --- -------- Appointments ------------ --- \n" +
            "\t6/5/1 at 12:10pm ,nullBirthday Party, This is my birthday party\n \n", string3);
  }
